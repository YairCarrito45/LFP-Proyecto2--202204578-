...
inst = ['CrearBD', 'EliminarBD', 'CrearColeccion', 'EliminarColeccion',
    'InsertarUnico', 'ActualizarUnico', 'EliminarUnico', 'BuscarTodo', 'BuscarUnico', 'new']
                    ...
                    if continuar:
                        ...
                        if lexema == '=':
                            if continuar:
                                continuar, tipo, lexema = leer_lexema()
                                if lexema == 'new':
                                    tokens.append(Tokens("new", n_linea, n_columna))
                                    if continuar:
                                        continuar, tipo, lexema = leer_lexema()
                                        if lexema == 'CrearBD':
                                            tokens.append(Tokens("CrearBD", n_linea, n_columna))
                    ...
                    if ascii_char == 8221 or ascii_char == 34:  # Cierre de comillas "
                        if continuar:
                            ...
                            if char == ')':
                                ...
                                if continuar:
                                    continuar, char = leer_siguiente()
                                    if char == '"' or ord(char) == 8220:  # Inicio de new comilla "
                                        parametro = ''
                                        while not salir and continuar:
                                            continuar, char = leer_siguiente()
                                            ascii_char = ord(char)
                                            if ascii_char == 8221:  # Cierre de new comilla "
                                                if continuar:
                                                    continuar, char = leer_siguiente()
                                                    if char == ')':
                                                        if continuar:
